...
class DySms
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIGBKLhAfxO28u"; // AccessKeyId

        $accessKeySecret = "eD0oWyUwpTWv7UidSibuqAHv4Y2NmD"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($mobile,$money) {
        ...
        $request->setSignName("涪陵燃气");

        // 必填，设置模板CODE，应严格按"模板CODE"填写, 请参考: https://dysms.console.aliyun.com/dysms.htm#/develop/template
        $request->setTemplateCode("SMS_154950441");
        ...
        // 可选，设置流水号
        $request->setOutId(time().rand(100,999));
